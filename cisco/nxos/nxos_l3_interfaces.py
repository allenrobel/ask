...
add_interface()                     Add an interface to the configuration::
                                        ...
                                        - Example:
                                            ...
                                            task.ipv4_tag = 10
                                            task.add_ipv4()
                                            task.ipv6_address = '2001:cccc::/64'
                                            task.ipv6_tag = 10
                                            task.add_ipv6()
                                            task.add_interface()
                                            task.state = 'merged'
...
add_ipv6()                          Append ivp6 properties to ipv6
                                    ...
                                    to None::
                                        ...
                                        - Example (see add_interface() for full example):
                                            ...
                                            task.name = 'Ethernet1/49'
                                            task.ipv6_address = '2001:aaaa::/64'
                                            task.ipv6_tag = 10
                                            task.add_ipv6()
                                            task.ipv6_address = '2001:bbbb::/64'
                                            task.ipv6_tag = 20
                                            task.add_ipv6()
                                            task.add_interface()
                                            task.state = 'merged'
                                        ...
                                        - Resulting playbook task:
                                            ...
                                            -   cisco.nxos.nxos_l3_interfaces:
                                                    config:
                                                    -   ipv6:
                                                        -   address: 2001:aaaa::/64
                                                            tag: 10
                                                        -   address: 2001:bbbb::/64
                                                            tag: 20
                                                        name: Ethernet1/49
                                                    state: merged
